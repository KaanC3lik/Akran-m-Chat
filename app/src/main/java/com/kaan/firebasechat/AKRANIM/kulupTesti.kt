...
class kulupTesti : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var sorular= arrayOf("Bilisim alanindaki kariyer olanaklarini ogrenmek ve bilgi sahibi olmak ilgini cekiyor mu? ","Muzik ve Sahne ile ilgileniyor ve onunla ilgi bir seyler yapmak ister misin ? ","Psikoloji alanida uzman konuklari agirlamak ve soylesilerine katilmak ilgini cekiyor mu ?","Yazilim alaninda projeler gelistirip cesitli yarismalara katilmak ister misin ?",
            "Herhangi bir enstruman aleti caliyor musun ? ","Farkli konulari tartisip bu konular uzerine konusmak ister misin ?","Bilisim sektorunun oncu firmalarinin ofisleri ve calisma alanlarini ziyaret edip isi mutfaginda gormek ister misin ?","Sahne almak ve bir grupla birlikte muzik yapmak ilgini cekiyor mu ? ","Cesitli terapi etkinliklerine katilip psikoloji alaninda bilgiler kazanmak ilgini ceker mi ?"
            ,"TEST BİTTİ")
